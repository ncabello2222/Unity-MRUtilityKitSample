...
namespace DA_Assets.UCC
{
    ...
    {
        public string GetHumanizedTextPrefabName(Node fobject)
        {
            string fontName = fobject.FontNameToString();
            string fontSize = fobject.Style.FontSize.ToString();

            string howAlig = fobject.Style.TextAlignHorizontal.ToString().ToPascalCase();
            string vertAlig = fobject.Style.TextAlignVertical.ToString().ToPascalCase();
        ...
        private string GetColorString(Node fobject)
        {
