...
namespace DA_Assets.UCC.Drawers
{
    ...
    public class NovaButtonDrawer : FcuBase
    {
        ...
        public void SetupNovaButton(Node fobject, ButtonVisuals btn)
        {
        ...
        public void SetDefaultTargetGraphic(Node fobject, SyncHelper[] syncHelpers, ButtonVisuals btnVisuals)
        {
            UIBlock gr1 = null;
